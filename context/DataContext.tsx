...
const initialUsers: User[] = [
    { name: 'Admin Two', householdId: 'ADM-ADMN-1746', identifier: '9064201746', password: 'adminpassword', role: 'admin', status: 'active', hasGreenBadge: true, bookingReminders: false, pushNotifications: true, emailNotifications: true, smsNotifications: false, profilePicture: '', email: 'admin2@ecotrack.com', createdAt: new Date(2024, 5, 1), outstandingBalance: 0, familySize: 1, address: { area: 'Admin Area', landmark: 'Admin Building', pincode: '000000' }, consecutiveMixedWasteLogs: 0 },
    { name: 'Jane Doe', householdId: 'HH-JANE-9876', identifier: 'jane.doe@example.com', password: 'Password@123', role: 'household', status: 'active', hasGreenBadge: false, bookingReminders: true, pushNotifications: true, emailNotifications: true, smsNotifications: true, profilePicture: '', email: 'jane.doe@example.com', createdAt: new Date(2024, 6, 10), outstandingBalance: 150, familySize: 6, address: { area: 'Willow Creek', landmark: 'Near Park', pincode: '123456' }, consecutiveMixedWasteLogs: 1 },
    { name: 'SHYANTAN BISWAS', householdId: 'ADM-SHYA-9052', identifier: '9635929052', password: 'Password@123', role: 'admin', status: 'active', hasGreenBadge: true, bookingReminders: true, pushNotifications: true, emailNotifications: true, smsNotifications: true, profilePicture: '', email: 'shyantanbiswas7@gmail.com', createdAt: new Date(2024, 5, 1), outstandingBalance: 75, familySize: 4, address: { area: 'Main Street', landmark: 'City Hall', pincode: '700001' }, consecutiveMixedWasteLogs: 0 },
    { name: 'Ravi Kumar', householdId: 'EMP-RAVI-1234', identifier: '8888888888', password: 'password123', role: 'employee', status: 'active', createdAt: new Date(2024, 5, 2), attendanceStatus: 'on_leave', familySize: 1, address: { area: 'Staff Quarters', landmark: 'Unit 5', pincode: '110022' }, outstandingBalance: 0, consecutiveMixedWasteLogs: 0, pushNotifications: false, emailNotifications: false, smsNotifications: false },
    { name: 'Suresh Singh', householdId: 'DRV-SURE-5678', identifier: '9999999999', password: 'password123', role: 'driver', status: 'active', createdAt: new Date(2024, 5, 3), attendanceStatus: 'on_leave', familySize: 1, address: { area: 'Staff Quarters', landmark: 'Unit 8', pincode: '110022' }, outstandingBalance: 0, consecutiveMixedWasteLogs: 0, pushNotifications: false, emailNotifications: false, smsNotifications: false },
];
